    ...
    return (
        <section className="bg-light text-light" style={{ display: `${showQuiz ? 'block' : 'none'}` }}>
            <div className="container">
                <div className="row vh-100 align-items-center justify-content-center border-radius:50px">
                    <div className="col-lg-8">
                        <div className="card p-4" style={{ background: 'lightpink', borderColor: 'black' }}>
